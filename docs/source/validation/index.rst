...
:class:`~pbhp.air_source_heat_pump_boiler.AirSourceHeatPumpBoiler`
...
`scripts/validation/samsung_ehs_parity.py
<https://github.com/bet-lab/pbhp/blob/main/scripts/validation/samsung_ehs_parity.py>`_,
...
.. admonition:: What has — and hasn't — been benchmarked
    ...
    (:class:`~pbhp.ground_source_heat_pump_boiler.GroundSourceHeatPumpBoiler`,
    :class:`~pbhp.water_source_heat_pump_boiler.WaterSourceHeatPumpBoiler`,
    :class:`~pbhp.air_source_heat_pump.AirSourceHeatPump`,
    :class:`~pbhp.ground_source_heat_pump.GroundSourceHeatPump`,
